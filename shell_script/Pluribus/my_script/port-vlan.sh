...
#            cli vrouter-interface-add vrouter-name leopst2 ip 22.3.$i.1/24 vlan $i if data mtu 9216 vrrp-id 10 vrrp-primary eth0.$i
#            cli vrouter-interface-add vrouter-name leopst2 ip 22.3.$i.3/24 vlan $i if data mtu 921

#            cli vrouter-interface-add vrouter-name leopst2 ip 22:3:$i:2::3/64 alias-on eth0.$i


#		cli vrouter-interface-add vrouter-name leopst2 ip 22:3:$i:2::1/64 vlan $i vrrp-id 10 vrrp-primary eth0.$i:1
